...
gene:                               buy/sell decision models(m - 1. buy high sell low(sharpe ratio); 2. RSI & SMA Crossover; 3. Cup with Handle )
chromesome:                         stock(s)
Population:                         portfolio(p = stocks + cash)
fitness:                            growth return (g) or Sharpe Ratio(return / sigma)
