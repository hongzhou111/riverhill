...
class StockTradingEnv(gym.Env):
    ...
    def __init__(self, ticker):
        ...
        ss.MACD_EMA_SHORT = 60
        ss.MACD_EMA_LONG = 130
        ss.MACD_EMA_SIGNAL = 45
        ss.macd()
        ss.rsi()
        #ss.bollinger()
...
ticker = 'TSLA'     #'FB'     #'AAPL'     #'ANTM'     #'AMZN'     #'TSLA'   #'BAND'     #'ROKU'     #'SHOP'     #'TWLO'
...
print(stock_env.current_step, model.predict(stock_env._next_observation()))
