...
class RLDailyTrader:
    def __init__(self, options):
        ...
        self.list = ['MSFT', 'SPY', 'SHOP', 'TWLO', 'ROKU', 'OKTA', 'PAYC', 'GOOGL', 'LYFT', 'TTD', 'AYX', 'ISRG', 'CRM',
                     ...
                     'OZK', 'TECK', 'VLO', 'SIM', 'NUE', 'PXD', 'STLD', 'GDDY', 'NXST', 'BIIB', 'BMRN', 'HES',
                     ...
                     'PAG', 'SJI', 'SPLP', 'TJX', 'PSN', 'FOUR', 'AON', 'UTZ', 'RSG', 'CNXN', 'BDX', 'BWXT', 'CTAS',
                     ...
                     'PTCT', 'TPR', 'RL', 'GEL', 'AIMC', 'EWZ', 'KNX', 'FWONA', 'MTD', 'COOP', 'ODFL', 'STOR', 'WAT',
                     ...
                     'MEI', 'PRIM', 'R', 'TDY', 'AMOV', 'XLE', 'FCX', 'PEP', 'HPE', 'ABB', 'AMX', 'EQIX', 'IBP', 'IYH',
        ...
        #   'SPSC', 'CHTR', 'UI', 'CTLT', 'XLRN','SPPT','MIME', 'MLYBY','SWCH', 'SRD','COUP','MYOV','EVOP',
